...
We used R version R-4.0.3 (Packaage versions listed below)
...
```{r}
ann = data.frame(cond = c('MI_32a', 'MI_32b', 'MI_27a', 'MI_27b', 'SM_32a', 'SM_32b', 'SM_27a', 'SM_27b'))
rownames(ann) <- names(explc)
```

Set colors for the heat map
```{r}
Var1        <- c("darkgoldenrod2", "darkolivegreen3", "dodgerblue3", "cyan", "aliceblue", "azure", "blue", "brown")
names(Var1) <- c('MI_32a', 'MI_32b', 'MI_27a', 'MI_27b', 'SM_32a', 'SM_32b', 'SM_27a', 'SM_27b')
...
Based on the GO Enrichment Categories, most DEGs in thermally tolerant symbionts that were up-regulated were related to metabolic processes and signalling pathways, with only a handful of down-regulated genes. Inversely, most DEGs in thermally sensitive symbionts were down-regulated, and these corresponded to cellular transport and metabolic processes. Up-regulated genes included cytoplasmic translation, and large and small ribosomal subunit assembly. This indicates that the thermally tolerant symbionts were able to adapt to the environment and resume normal metabollic activity, while the thermally sensitive symbionts slowed metabollic processes and instead focused on cytoplasmic translation (necessary for increased heterotrophy in coral host) and some protein creation.
