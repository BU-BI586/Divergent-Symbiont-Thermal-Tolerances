...
rownames(ann_column) = colnames(rld)
...
pheatmap(as.matrix(rld),annotation_col=ann_column,annotation_colors=ann_colors,cex=0.6,color=col0,border_color=NA,clustering_distance_rows="correlation",clustering_distance_cols="correlation", show_rownames=T)
```
